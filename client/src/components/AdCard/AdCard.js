    ...
    return (
        <div className="ad-card">
            <div className="ad-card__content">
                <h3 className="ad-card__title">{title || 'Título no disponible'}</h3>
                <p className="ad-card__description">{description || 'Descripción no disponible'}</p>
                <div className="ad-card__details">
                    <p className="ad-card__price">{amount || 'Cantidad no disponible'}</p>
                    <p className="ad-card__location">{location || 'Ubicación no disponible'}</p>
                </div>
